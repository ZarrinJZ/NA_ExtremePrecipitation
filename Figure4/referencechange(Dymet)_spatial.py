...
def plot(X, Y, values, lons, lats, key):
    ...
    # cmap5 = mpl.colors.LinearSegmentedColormap.from_list('cmap5',
    #                                                     [( 0,'#FFFAF0'),
    #                                                      (0.25,'#BFEFFF'),
    #                                                      (0.5, '#87CEFF'),
    #                                                      (0.75, '#EEAEEE'),
    ...
    plt.tight_layout()
    plt.savefig("chapter4.3_Daymet_"+titleout + '.png', format='png', transparent=True, dpi=100, pad_inches=0.1, bbox_inches='tight')
    plt.show()
