...
if __name__ == '__main__':
    rootpath = "/Volumes/OneTouch/Calculated_Indices_FutureAnalysis/15_Txx_Tnn/Time_series/1981-2100/csv"
    for dir2 in os.listdir(rootpath):
        if dir2.endswith(".nc") and (not dir2.startswith("._")):
            with open("/Volumes/OneTouch/Calculated_Indices_FutureAnalysis/15_Txx_Tnn/Time_series/1981-2100/res/" + dir2.replace(".nc", ".txt"), 'w') as f:
